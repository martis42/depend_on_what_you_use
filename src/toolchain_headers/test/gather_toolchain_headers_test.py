...
from src.toolchain_headers.gather_toolchain_headers import gather_built_in_headers, gather_toolchain_headers
...
class TestGatherBuiltInHeaders(unittest.TestCase):
    ...
    def test_filter_and_gather_files(self) -> None:
        result = gather_built_in_headers(
            [Path("src/toolchain_headers/test/data/other_dir"), Path("src/toolchain_headers/test/data/some/dir")]
        )
