...
from src.cc_toolchain_headers.private.gather_cc_toolchain_headers import (
...
class TestGatherBuiltInHeaders(unittest.TestCase):
    ...
    def test_filter_and_gather_files(self) -> None:
        result = gather_toolchain_headers(
            [
                Path("src/cc_toolchain_headers/private/test/data/include_root"),
                Path("src/cc_toolchain_headers/private/test/data/include_root/bar"),
            ]
        )
