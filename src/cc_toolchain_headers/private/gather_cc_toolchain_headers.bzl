...
visibility("//src/cc_toolchain_headers/...")
...
gather_cc_toolchain_headers = rule(
    ...
    attrs = {
        ...
        "_empty_cpp": attr.label(
            default = Label("//src/cc_toolchain_headers/private:empty.cpp"),
            allow_single_file = True,
        ),
        "_gatherer": attr.label(
            default = Label("//src/cc_toolchain_headers/private:gather_cc_toolchain_headers_tool"),
            executable = True,
            cfg = "exec",
        ),
    },
