...
def cli() -> Namespace:
    ...
    parser.add_argument(
        ...
        metavar="FILE",
        type=Path,
        help="File with a list of all include statements available through the CCtoolchain. Json format is expected.",
    )
    parser.add_argument(
...
def main(args: Namespace) -> int:
    ignored_includes = get_ignored_includes(
        config_file=args.ignored_includes_config, system_headers_info=args.system_headers_info
    )
