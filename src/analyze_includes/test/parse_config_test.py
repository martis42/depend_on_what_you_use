...
class TestLoadConfig(unittest.TestCase):
    def test_load_empty(self):
        ignored_inclues, extra_ignoredf_includes = load_config(Path("src/analyze_includes/test/data/config_empty.json"))

        self.assertEqual(ignored_inclues, [])
        self.assertEqual(extra_ignoredf_includes, [])

    def test_load_config(self):
        ignored_includes, extra_ignored_includes = load_config(Path("src/analyze_includes/test/data/config.json"))
