...
class TestCase(TestCaseBase):
    ...
    def execute_test_logic(self) -> Result:
        self._create_reports(
            aspect="//tool_cli/workspace:aspect.bzl%default_aspect", extra_args=["--compilation_mode=opt"]
        )
        ...
        self._run_automatic_fix(extra_args=["--fix-unused", "--bazel-args", "--remote_cache= -c opt"])
