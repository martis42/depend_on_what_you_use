...
class TestCase(TestCaseBase):
    ...
    def test_target(self) -> str:
        return "//needlessly_public_dependency/workspace:public_dependency_with_private_use"

    def execute_test_logic(self) -> Result:
        self._create_reports(aspect="//needlessly_public_dependency/workspace:aspect.bzl%optimizes_impl_deps_aspect")
        ...
        expected_deps = {"//needlessly_public_dependency/workspace:lib_c"}
        expected_implementation_deps = {
            "//needlessly_public_dependency/workspace:lib_a",
            "//needlessly_public_dependency/workspace:lib_b",
        }
