...
# Thus the aspect additionally exposes each direct dependency's (already recursively aggregated) cc_info and the
# rule applies the 'filter' attribute itself when merging them.
