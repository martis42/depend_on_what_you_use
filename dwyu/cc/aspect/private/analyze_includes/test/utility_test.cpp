#include "dwyu/cc/aspect/private/analyze_includes/utility.h"
...
TEST(ReadJsonFromFile, ReadData) {
    const auto result =
        readJsonFromFile("dwyu/cc/aspect/private/analyze_includes/test/data/target_under_inspection.json");
