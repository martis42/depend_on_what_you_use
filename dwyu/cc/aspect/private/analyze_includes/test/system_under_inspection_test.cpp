...
TEST(GetSystemUnderInspection, GivenTargetUnderInspectionReadAllDataCorrectly) {
    const auto system = getSystemUnderInspection(
        "dwyu/cc/aspect/private/analyze_includes/test/data/target_under_inspection.json", {}, {});
...
TEST(GetSystemUnderInspection, GivenTargetUnderInspectionWithoutHeadersExpectData) {
    const auto system = getSystemUnderInspection(
        "dwyu/cc/aspect/private/analyze_includes/test/data/target_under_inspection_no_headers.json", {}, {});
...
TEST(GetSystemUnderInspection, GivenDepsWithoutHeadersExpectEmptyMaps) {
    const auto system =
        getSystemUnderInspection("dwyu/cc/aspect/private/analyze_includes/test/data/target_under_inspection.json",
                                 {"dwyu/cc/aspect/private/analyze_includes/test/data/dep_info_no_headers.json"},
                                 {"dwyu/cc/aspect/private/analyze_includes/test/data/dep_info_no_headers.json"});
...
TEST(GetSystemUnderInspection, GivenDepsWithHeadersReadAndCombineThemCorrectly) {
    const auto system =
        getSystemUnderInspection("dwyu/cc/aspect/private/analyze_includes/test/data/target_under_inspection.json",
                                 {"dwyu/cc/aspect/private/analyze_includes/test/data/dep_info_foo.json",
                                  "dwyu/cc/aspect/private/analyze_includes/test/data/dep_info_foobar.json"},
                                 {"dwyu/cc/aspect/private/analyze_includes/test/data/impl_dep_info_fizz.json",
                                  "dwyu/cc/aspect/private/analyze_includes/test/data/impl_dep_info_buzz.json"});
...
TEST(GetSystemUnderInspection, GivenDuplicateHeadersFromDifferentDepsExpectMappingToCorrectDeps) {
    const auto system =
        getSystemUnderInspection("dwyu/cc/aspect/private/analyze_includes/test/data/target_under_inspection.json",
                                 {"dwyu/cc/aspect/private/analyze_includes/test/data/dep_info_duplicate_header_a.json",
                                  "dwyu/cc/aspect/private/analyze_includes/test/data/dep_info_duplicate_header_b.json"},
                                 {});
