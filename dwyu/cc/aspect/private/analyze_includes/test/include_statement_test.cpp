#include "dwyu/cc/aspect/private/analyze_includes/ignored_includes.h"
...
TEST(GetIncludeStatements, ReadingFileWithoutDataYieldsAnEmptyList) {
    const auto includes =
        getIncludeStatements({"dwyu/cc/aspect/private/analyze_includes/test/data/preprocessed_file_empty.json"}, {});
...
TEST(GetIncludeStatements, ReadingFileWithoutIncludesDataYieldsAnEmptyList) {
    const auto includes = getIncludeStatements(
        {"dwyu/cc/aspect/private/analyze_includes/test/data/preprocessed_file_without_includes.json"}, {});
...
TEST(GetIncludeStatements, ReadingMultipleFiles) {
    const auto includes = getIncludeStatements(
        {"dwyu/cc/aspect/private/analyze_includes/test/data/preprocessed_files_with_includes.json"}, {});
...
TEST(GetIncludeStatements, FilterOutIgnoredIncludes) {
    ...
    const auto includes = getIncludeStatements(
        {"dwyu/cc/aspect/private/analyze_includes/test/data/preprocessed_files_with_includes.json"}, ignores);
