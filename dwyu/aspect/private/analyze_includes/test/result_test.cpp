...
TEST(Result, ToStringForSuccess) {
    ...
    const std::string expected_output =
        ...
        "Result: SUCCESS\n"
        "================================================================================\n";
    EXPECT_EQ(unit.toString(), expected_output);
}
...
TEST(Result, dumpToFileForSuccess) {
    const Result unit{"//:foo", true};
...
TEST(Result, dumpToFileForFailure) {
    const std::vector<std::string> unused_deps{"unused_dep", "another_unused_dep"};
    const std::vector<std::string> unused_impl_deps{"unused_impl_dep", "another_unused_impl_dep"};
    const std::vector<std::string> public_deps_which_should_be_private{"public_dep_which_should_be_private",
                                                                       "another_public_dep_which_should_be_private"};
